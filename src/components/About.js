        ...
        <div className="About">
            <div className="wrapper">
                ...
                <div class="information-body">
                    ...
                    <p className="information-text">This website was created as a means of spreading awareness around this fight for racial equality. The <a href="/actions" style={{textDecoration: 'underline', color: '#341F2C'}}>What To Do</a> page contains various resources and ways you can help in supporting this cause and the <a href="/sources" style={{textDecoration: 'underline', color: '#341F2C'}}>Sources</a> page contains additional resources.</p>
                </div>
            </div>
        </div>
    </Main>
